...
st.markdown("""
    ...
    /* VOLTANDO AO ORIGINAL: Estilo que funcionava para inputs e selectbox */
    ...
    /* =================================================================== */
    /* NOVA CORREÇÃO DEFINITIVA PARA O EXPANSOR (HEADER E CONTEÚDO)        */
    /* =================================================================== */

    /* Estiliza o CABEÇALHO do expansor (a parte que clica) */
    ...
    /* Remove o ícone de seta padrão e coloca um customizado */
    ...
    div[data-testid="stExpander"][aria-expanded="true"] summary::after {
        transform: rotate(180deg); /* Gira a seta quando aberto */
    }

    /* Estiliza a ÁREA DE CONTEÚDO quando o expansor está aberto */
    div[data-testid="stExpander"] div[role="region"] {
        background-color: rgba(30, 30, 30, 0.7) !important; /* Cinza escuro, igual aos inputs */
        border-radius: 0 0 8px 8px !important;
        padding-top: 1rem !important;
        margin-top: -8px !important; /* Puxa o conteúdo para cima para colar no header */
    }

    /* Garante que o container interno do conteúdo seja transparente */
...
for i in range(qtd_modelos_modulos):
    with st.expander(f"Modelo de Módulo Auxiliar #{i+1}"):
        # ... (código interno do expander continua o mesmo)
...
if total > 0:
    ...
    # Botões
    # ... (código dos botões continua o mesmo)
